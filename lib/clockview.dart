...
class _ClockViewState extends State<ClockView> {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 300,
      height: 300,
      // used transform rotate because canvas starts at 90 so we reduce it by 90 of a circle
...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var innerCircleRafius = radius - 14;
    for (double i = 0; i < 360; i += 12) {
      var x1 = centerX + outerCircleRadius * cos(i * pi / 180);
      var y1 = centerX + outerCircleRadius * sin(i * pi / 180);

      var x2 = centerX + innerCircleRafius * cos(i * pi / 180);
      var y2 = centerX + innerCircleRafius * sin(i * pi / 180);
